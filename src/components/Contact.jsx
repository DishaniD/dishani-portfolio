  ...
  return (
    <section className="py-16" id="contact" ref={contactRef}>
      <div className="px-4 text-center">
        ...
        <p className="contact-test mb-4 text-lg lg:text-xl">
          Feel free to reach out to me via email:{" "}
          <a href="mailto:david@example.com" className="border-b">
            dilrukshi.dishani@gmail.com
          </a>
        </p>
        <div className="mt-8 flex justify-center space-x-6">
          <a
            href="https://www.linkedin.com/in/dishani-dilrukshi/"
            target="_blank"
          ...
          <a
            href="https://github.com/DishaniD"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-icon"
